...
### Update: 2025-09-28 16:55
- Toast badge font now matches preset buttons (lighter, smaller), padding balanced; x-axis tick logic now rounds against actual data min/max rather than padded scale values.
